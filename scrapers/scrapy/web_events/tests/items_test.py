...
（西武拝島線東大和駅より徒歩10分）
東京都東大和市向原6-1
※新宿から約50分""": u'東大和市民会館ハミングホール 大ホール',
        #u"""※会場が変更になりました""":
        #'',
        u"""場所
...
Mt.RAINIER HALL SHIBUYA PLEASURE PLEASURE""": u'Mt.RAINIER HALL SHIBUYA PLEASURE PLEASURE',
        u"""場所

DIFFER有明""": u'DIFFER有明',
        u"""場所

CLUB CITTA'""": u"CLUB CITTA'",
        u"""【場所】グランフロント大阪 うめきた広場テントステージ""": u'グランフロント大阪 うめきた広場テントステージ',
