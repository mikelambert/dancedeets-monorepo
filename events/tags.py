...
CHOREO_FREESTYLE_LOOKUP = {}
CHOREO_FREESTYLE_LOOKUP.update(dict((x[0], CHOREO_EVENT) for x in CHOREO_EVENT_LIST))
CHOREO_FREESTYLE_LOOKUP.update(dict((x[0], FREESTYLE_EVENT) for x in FREESTYLE_EVENT_LIST))
