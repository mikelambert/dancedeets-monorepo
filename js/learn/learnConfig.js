...
export const defaultTutorials = [
  ...
  },
  {
    ...
    tutorials: [
      ...
      require('./tutorials/waack/kumari.json'),
      require('./tutorials/waack/christina.json'),
      require('./tutorials/waack/miscellaneous.json'),
      require('./tutorials/waack/mizuki.json'),
      require('./tutorials/misc/soul_munehiro_sugita.json'),
      require('./tutorials/misc/soul_koichi.json'),
      require('./tutorials/misc/soul_hakata.json'),
      require('./tutorials/misc/soul_so.json'),
      require('./tutorials/misc/soul_ricky.json'),
