...
const defaultTutorials = {
  ...
  'Popping': [
    ...
    require('./pop/dancestylepopping.json'),
    require('./pop/dancestylepopping2.json'),
    require('./pop/dancestyleanimation.json'),
  ...
  'Breaking': [
    require('./break/vincanitv_beginnertutorials.json'),
    require('./break/vincanitv_intermediatetutorials.json'),
    require('./break/vincanitv_advancedtutorials.json'),
    require('./break/vincanitv_toprock basics.json'),
    require('./break/vincanitv_getdowns.json'),
    require('./break/vincanitv_footwork101.json'),
    require('./break/vincanitv_freezebasics.json'),
    require('./break/vincanitv_flipbasics.json'),
    require('./break/vincanitv_powermoves.json'),
