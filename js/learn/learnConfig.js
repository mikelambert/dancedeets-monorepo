...
export const defaultTutorials = [
  {
    title: 'House Dance',
    thumbnail: require('./images/styles/house.jpg'),
    tutorials: [
  ...
  {
    title: 'Locking',
    thumbnail: require('./images/styles/lock.jpg'),
    tutorials: [
  ...
  {
    title: 'Popping',
    thumbnail: require('./images/styles/pop.jpg'),
    tutorials: [
  ...
  },
  {
    ...
    thumbnail: require('./images/styles/break.jpg'),
    tutorials: [
