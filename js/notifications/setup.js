...
class Handler {
  ...
  async sendUpcomingEventReminder(event: Event) {
    ...
    // TODO NOW: Look up SharedPreference for whether we want to play sounds?
    ...
    const playSound = await getPreference('playSounds', true);
    ...
    */
    ...
    if (notification.userInteraction) {
      ...
      if (notification.notification_type === 'EVENT_REMINDER') {
        const notificationsEnabled = await getPreference('enabled', true);
        const notificationsUpcomingEventsEnabled = await getPreference('enabled.upcomingEvents', true);
