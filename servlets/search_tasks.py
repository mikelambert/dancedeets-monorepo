...
def mr_refresh_index(fbl):
    fb_mapreduce.start_map(
        ...
        handler_spec='servlets.search_tasks.map_refresh_event',
...
class MemcacheFutureEvents(tasks.BaseTaskFacebookRequestHandler):
    def get(self):
        search.memcache_future_events(self.fbl)

class RefreshFulltextSearchIndex(tasks.BaseTaskFacebookRequestHandler):
    def get(self):
