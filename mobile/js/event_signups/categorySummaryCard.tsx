...
class CompactTeam extends React.Component<CompactTeamProps> {
  render() {
    return (
...
class CategorySummaryCard extends React.Component<CategorySummaryCardProps> {
  _root?: View;
