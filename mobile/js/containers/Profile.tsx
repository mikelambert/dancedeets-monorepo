...
class _ShareButtons extends React.Component<ShareButtonsProps> {
  getShareLinkContent() {
...
interface UserProfileProps {
  ...
  intl: IntlShape;
  logIn: () => void;
  logOutWithPrompt: (intl: IntlShape) => void;
}

class _UserProfile extends React.Component<UserProfileProps> {
  render() {
...
const UserProfile = connect(
  ...
  (dispatch: Dispatch) => ({
    ...
    logOutWithPrompt: (intl: IntlShape) => dispatch(logOutWithPrompt(intl)),
  })
...
class ButtonIcon extends React.Component<ButtonIconProps> {
  render() {
    return (
      <Icon
        name={
