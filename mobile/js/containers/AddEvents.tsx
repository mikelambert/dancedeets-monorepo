...
class _AddEventList extends React.Component<
  ...
  AddEventListState
> {
  static applyFilterSorts(props: AddEventListProps, results: AddEventData[]) {
  ...
  renderRow({ item }: { item: AddEventData }) {
    return (
      <AddEventRow
        event={item}
  ...
  render() {
    ...
    const results = _AddEventList.applyFilterSorts(
      this.props,
