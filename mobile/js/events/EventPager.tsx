...
import { ThunkAction } from '../actions/types';
...
class EventPager extends React.Component<EventPagerProps, EventPagerState> {
  constructor(props: EventPagerProps) {
    super(props);
    this.state = {
      position: null,
      loadInProgress: true,
  ...
  getNewState(props: EventPagerProps, oldPosition: any) {
