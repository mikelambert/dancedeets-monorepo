...
// Note: redux-persist v6+ ships with built-in TypeScript definitions
// Note: @react-navigation/* v7+ ships with built-in TypeScript definitions
...
// Note: react-intl v7+ ships with built-in TypeScript definitions
