...
examples = {
    ...
    u'2016년 3월 5일(토), 밤 11시부터 새벽': (datetime.datetime(2016, 3, 5, 12 + 11), datetime.datetime(2016, 3, 5,
                                                                                              korean_dates.DAWN)),  # "at 11pm (until)dawn"
    ...
    u'2016년 2월 27일(토), 예선 오후 1시 / 본선 오후 4시 30분': (datetime.datetime(2016, 2, 27, 12 + 1),
                                                  datetime.datetime(2016, 2, 27, 12 + 4, 30)),  # prelim pm 1 / main pm 4 : 30
    ...
    u'2016년 2월 20일 토요일, 힙합 예선 2시, 왁킹 예선 3시, 본선 5시 30분부터': (datetime.datetime(2016, 2, 20, 12 + 2),
                                                           None),  # hiphop pm 2, waacking pm 3, main 5 : 30 from
