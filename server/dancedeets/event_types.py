...
VERTICALS.ZOUK = 'ZOUK'
VERTICALS.WCS = 'WCS'
VERTICALS.PARTNER_FUSION = 'PARTNER_FUSION'
VERTICALS.ROCKABILLY = 'ROCKABILLY'
VERTICALS.COUNTRY = 'COUNTRY'
VERTICALS.CONTACT = 'CONTACT'
VERTICALS.AFRICAN = 'AFRICAN'
VERTICALS.BELLY = 'BELLY'
VERTICALS.SOULLINE = 'SOULLINE'
