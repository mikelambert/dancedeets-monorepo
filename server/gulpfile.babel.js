...
gulp.task('compile:geonames:fetch_adgeolocs', $.shell.task('PYTHONPATH=lib-local:lib-both:. python ./geonames/fetch_adgeolocs.py'))
gulp.task('compile:geonames:build_cities_db', ['compile:geonames:fetch_adgeolocs'], $.shell.task('PYTHONPATH=lib-local:lib-both:. python ./geonames/build_cities_db.py ./geonames/cities.db'))
gulp.task('compile:geonames', ['compile:geonames:build_cities_db'])

gulp.task('compile:test-geonames:build_cities_db', $.shell.task('PYTHONPATH=lib-local:lib-both:. DUMMY_FILE=1 python ./geonames/build_cities_db.py ./geonames/cities_test.db'))
